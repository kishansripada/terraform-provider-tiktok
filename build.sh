...
plugin_dir="$provider_dir/.terraform/plugins/registry.terraform.io/singingbuddy/tiktok/0.1.0/$platform"
mkdir -p "$plugin_dir"
cd "$provider_dir"
CGO_ENABLED=0 go build -trimpath -buildvcs=false -o "$plugin_dir/terraform-provider-tiktok_v0.1.0" .
