# tiktok_smart_plus_campaign

Manage one smart plus campaign through the TikTok Marketing API.

Import: `terraform import tiktok_smart_plus_campaign.example "ADVERTISER_ID/RESOURCE_ID"`.
...
| `special_industries` | `list(string)` | No | No |
